  ...
  const specs = [
    {
      ...
      output: '2.8 KW',
      kelvin: '3200K / 5600K',
      wattage: '2800 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
    ...
    },
    {
      ...
      output: '4.0 KW',
      kelvin: '3200K / 5600K',
      wattage: '4000 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW / Tungsten / HMI / Mix',
    },
    {
      ...
      output: '2.0 KW',
      kelvin: '3200K / 5600K',
      wattage: '2000 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW / Tungsten / HMI / Mix',
    },
    ...
    },
    {
      ...
      output: '1.0 KW',
      kelvin: '3200K / 5600K',
      wattage: '1000 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW / Tungsten / HMI / Mix',
    },
    {
      ...
      output: '4.7 KW',
      kelvin: '3200K / 5600K',
      wattage: '4700 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW / Tungsten / HMI / Mix',
    },
    {
      ...
      output: '1.4-2.8 KW',
      kelvin: '3200K / 5600K',
      wattage: '1400 W - 2800 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW / Tungsten / HMI / Mix',
    },
    {
      model: 'Flat light 8x8 (2,4x2,4 m)',
      output: '1.2-2.0 KW',
      kelvin: '2700K-6500K',
      wattage: '1200 - 2000 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW',
    },
    {
      model: 'Flat light 4x8 (1,2x2,4 m)',
      output: '0.6-1.0 KW',
      kelvin: '2700K-6500K',
      wattage: '600 - 1000 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW',
    },
    {
      model: 'Flat light 4x4 (1,2x1,2 m)',
      output: '0.3-0.5 KW',
      kelvin: '2700K-6500K',
      wattage: '300 - 500 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW',
    },
    {
      ...
      output: '0.3 KW',
      kelvin: '2700K-6500K',
      wattage: '300 W pro každou barvu',
      dimming: '0-100%',
      cri: '95+',
      type: 'LED RGBWW',
    },
